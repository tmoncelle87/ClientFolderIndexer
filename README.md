...
A lightweight C# console utility designed to generate professional directory catalogs. It scans a specified path and exports an alphabetically sorted list of all subfolders directly into a styled Excel (.xlsx) spreadsheet. 

## Features
* **Automated Scanning:** Extracts all subfolder names from a target directory without pulling unnecessary file extensions.
